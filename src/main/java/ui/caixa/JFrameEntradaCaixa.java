 ...
 * @author skate
 */
public class JFrameEntradaCaixa extends javax.swing.JFrame {
    ...
    /**
     * Creates new form Entradaaixa
     */
    public JFrameEntradaCaixa() {
        initComponents();
        ...
        try {
            ...
            if (estadoAtual == null || !estadoAtual) {
                this.bloquearCampos();
                JOptionPane.showMessageDialog(null, "Não é possível realizar uma entrada em um caixa que ainda não foi aberto", "Ô loco meu!", JOptionPane.WARNING_MESSAGE);
            }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("FLUXO DE CAIXA [ENTRADA]");
        ...
        jLabel8.setText(" Forma de Entrada*");
        jLabel8.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 1, true));
        jLabel8.setOpaque(true);

        comboForma.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "SELECIONE...", "CARTÃO DE CRÉDITO", "CARTÃO DE DÉBITO", "DINHEIRO" }));
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            ...
                            .addComponent(jLabel8, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 185, Short.MAX_VALUE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(campoValor)
                            .addComponent(jScrollPane1)
                            .addComponent(campoDescricao)
                            .addComponent(comboForma, javax.swing.GroupLayout.PREFERRED_SIZE, 483, javax.swing.GroupLayout.PREFERRED_SIZE))))
        ...
        setSize(new java.awt.Dimension(735, 505));
        setLocationRelativeTo(null);
    }// </editor-fold>//GEN-END:initComponents

    private void btnGravarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGravarActionPerformed
        if(StringUtils.isNullOrEmpty(campoDescricao.getText()) || StringUtils.isNullOrEmpty(campoDescricao.getText())
                || comboForma.getSelectedIndex() < 1){
        ...
        int dialogResult = JOptionPane.showConfirmDialog(null, "<html>Deseja realmente realizar essa <b>Entrada</b> no caixa?</html>", "Galera de casa aí, comé que é, meu", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
        if (dialogResult == JOptionPane.YES_OPTION) {
            try {
                this.buildMovimento();
                repository.inserirMovimentoCaixa(movimento);
                this.limparCampos();
                JOptionPane.showMessageDialog(this, "Entrada de caixa realizada com sucesso!", "Quem sabe faz ao vivo!", JOptionPane.INFORMATION_MESSAGE);
            } catch (SQLException ex) {
                System.out.println(ex.getMessage());
                JOptionPane.showMessageDialog(this, "Ocorreu um erro ao tentar realizar a Entrada de Caixa", "Errrrôôôôôuuuu!", JOptionPane.ERROR_MESSAGE);
            }
        }
    ...
    private void buildMovimento() {
        movimento = MovimentoCaixaModel.builder()
                ...
                .formaEntrada(comboForma.getSelectedItem().toString())
                .build();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrameEntradaCaixa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
