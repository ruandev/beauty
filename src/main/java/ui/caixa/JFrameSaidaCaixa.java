...
public class JFrameSaidaCaixa extends javax.swing.JFrame {
    ...
    /**
     * Creates new form JFrameSaidaCaixa
     */
       ...
       int dialogResult = JOptionPane.showConfirmDialog(null, "<html>Deseja realmente realizar essa <b>Saída</b> no caixa?</html>","Galera de casa aí, comé que é, meu",JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
        if(dialogResult == JOptionPane.YES_OPTION){
            try {
                ...
                this.limparCampos();
                JOptionPane.showMessageDialog(this, "Saída de caixa realizada com sucesso!", "Quem sabe faz ao vivo!", JOptionPane.INFORMATION_MESSAGE);
            } catch (SQLException ex) {
                System.out.println(ex.getMessage());
                JOptionPane.showMessageDialog(this, "Ocorreu um erro ao tentar realizar a Saída de Caixa", "Errrrôôôuuuu!", JOptionPane.ERROR_MESSAGE);
            }
        }
